...
function UserForm({ onAddUser, onCancel }) {
  ...
  return (
    <div className="mt-8 bg-slate-800/50 border border-slate-700/50 p-8 rounded-2xl shadow-xl animate-slideUp">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3">
          <button
            type="submit"
            className="flex-1 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg font-semibold hover:from-emerald-700 hover:to-emerald-800 transition shadow-lg hover:shadow-emerald-500/50 transform hover:scale-105 duration-200"
          >
            Add Member
          </button>
          <button
